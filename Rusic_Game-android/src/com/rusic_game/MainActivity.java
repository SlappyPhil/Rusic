...
public class MainActivity extends AndroidApplication {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ListAllSongs();
        Log.i("SIZE OF ARRAY: ", Integer.toString(musicinfo.length));
        Log.i("TEST VALUE: ", musicinfo[0]); 
        Log.i("SIZE OF ARRAY: ", Integer.toString(musicpath.length)); 
        Log.i("SIZE OF ARRAY: ", musicpath[0]); 
